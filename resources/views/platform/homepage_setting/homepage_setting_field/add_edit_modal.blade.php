...
<!--end::Header-->
<!--begin::Body-->
<form id="add_homepage_field_form" class="form" action="#" enctype="multipart/form-data">
...
$('.mobile_num').keypress(
    ...
    var add_url = "{{ route('homepage-setting-field.save') }}";

    // Class definition
    var KTUsersAddHomepageField = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_homepage_field_form');
        ...
        var initAddHomepageField = () => {
            ...
            $('#add_homepage_field_form').submit(function(e) {
                ...
                if (validator) {
                    validator.validate().then(function(status) {
                        if (status == 'Valid') {
                            var from = $('#from').val();
                            var formData = new FormData(document.getElementById("add_homepage_field_form"));
