    ...
    <div class="card">
            ...
            <div class="card-toolbar w-100">
                <div class="d-flex justify-content-end w-100" data-kt-wishlist-table-toolbar="base">
                    @if( access()->hasAccess('tax', 'filter') )
                        @include('platform.wishlist._filter')
                    @endif

                    @include('platform.layouts.parts.common._export_button')

                    {{-- <button type="button" class="btn btn-primary" onclick="return openForm('wishlist')">
        ...
        <div class="card-body py-4">
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-2 mb-0 dataTable no-footer" id="wishlist-table">
                    <thead>
...
@section('add_on_script')
    ...
    <script >
    var dtTable = $('#wishlist-table').DataTable({
