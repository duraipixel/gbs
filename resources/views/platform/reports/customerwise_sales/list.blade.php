...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        @include('platform.reports.customerwise_sales._export_button')
    </div>
</div>
@endsection
@section('content')
    <div id="kt_content_container" class="container-xxl">
        <div class="card">
            <div class="card-header border-0 pt-6 w-100">
                @include('platform.reports.customerwise_sales._filter_form')
            </div>
            <hr>
            <!--end::Card header-->
            <!--begin::Card body-->
...
@section('add_on_script')
    ...
    <script>
        ...
        var dtTable = $('#product-table').DataTable({
            ...
            type: 'POST',
            ajax: {
                "url": "{{ route('reports.customerwise') }}",
                "data": function(d) {
                    console.log(d);
            ...
            columns: [
                ...
                {
                    data: 'cus_coupon_amount',
                    name: 'cus_coupon_amount'
                },
                {
