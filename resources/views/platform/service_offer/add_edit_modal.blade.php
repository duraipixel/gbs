                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="service_center_id" id="service_center_id" aria-label="Select a service center" data-control="select2" data-placeholder="Select a service center..." class="form-select mb-2">
                                    <option value="">Select service center</option>
                                    @isset($serviceCenter)
                                        @foreach ($serviceCenter as $item)
                                            <option value="{{ $item->id }}" @if( isset( $info[0]->service_center_id ) && $info[0]->service_center_id == $item->id ) selected @endif>{{ $item->title }}</option>
                                        @endforeach
                                    @endisset
                                </select>
                            </div>
...
<script>
    ...
    // Class definition
    var KTUsersServiceOffer = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_service_offer_form');
            ...
            $('#add_service_offer_form').submit(function(e) {
                ...
                if (validator) {
                    validator.validate().then(function(status) {
                        if (status == 'Valid') {
                            var from = $('#from').val();
                            var formData = new FormData(document.getElementById("add_service_offer_form"));
