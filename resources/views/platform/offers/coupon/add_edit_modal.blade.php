                            ...
                            <div class="col">
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="coupon_type" id="coupon_type" aria-label="Select a Coupon Type"
                                        ...
                                        {{-- <option value="2" @if (isset($info->coupon_type) && $info->coupon_type == '2') selected="selected" @endif>Combo Products</option> --}}
                                        <option value="3"
                                            @if (isset($info->coupon_type) && $info->coupon_type == '3') selected="selected" @endif>Category
                                        </option>
                                        <option value="4"
                                            @if (isset($info->coupon_type) && $info->coupon_type == '4') selected="selected" @endif>Order Value
                                        </option>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        @if (isset($couponTypeAttributes) && !empty($couponTypeAttributes))
                                            @foreach ($couponTypeAttributes as $item)
                                                <option value="{{ $item->id }}"
                                                    @if (isset($info->couponProducts) && in_array($item->id, array_column($info->couponProducts->toArray(), 'product_id'))) selected="selected" 
                                                    @elseif(isset($info->couponCustomers) &&
                                                            in_array($item->id, array_column($info->couponCustomers->toArray(), 'customer_id'))) 
                                                    selected="selected" 
