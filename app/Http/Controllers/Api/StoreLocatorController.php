...
class StoreLocatorController extends Controller
{
    ...
    public function getStoreLocatorDetail(Request $request)
    {
        ...
        ->where('slug',$slug)
        ->select('id','brand_id','parent_id','title','slug','banner','banner_mb','store_image','store_image_mb','description','address','latitude','longitude','email','contact_no','status','order_by')->first();
